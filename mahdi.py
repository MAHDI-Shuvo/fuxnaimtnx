...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/MAHDI-Shuvo/new/main/imt.txt').text
    if to in r:
        ip()
    else:
        os.system('clear')
...
def menu_s():
    ...
    if ms == '1':
        ...
        os.system('cd $HOME && git clone https://github.com/MAHDI-Shuvo/fuxnaimtnx.git')
        time.sleep(1)
        os.system('cd $HOME/fuxnaimtnx && python mahdi')
    elif ms == '2':
